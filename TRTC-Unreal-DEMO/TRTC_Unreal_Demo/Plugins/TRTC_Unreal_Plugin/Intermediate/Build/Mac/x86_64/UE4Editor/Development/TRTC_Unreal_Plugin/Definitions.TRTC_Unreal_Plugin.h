...
#define UE_PROJECT_NAME TRTC_Unreal_Demo
#define UE_TARGET_NAME TRTC_Unreal_DemoEditor
#define UE_MODULE_NAME "TRTC_Unreal_Plugin"
#define UE_PLUGIN_NAME "TRTC_Unreal_Plugin"
...
#define TRTC_UNREAL_PLUGIN_API DLLEXPORT
