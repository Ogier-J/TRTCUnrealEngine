#import "GenerateTestUserSigOC.h"
#import <CommonCrypto/CommonCrypto.h>
#import <zlib.h>

@implementation GenerateTestUserSigOC

+ (NSString *)genTestUserSig:(NSString *)identifier:(int)SDKAppID:(NSString *)SECRETKEY
{
    ...
    NSString *sig = [self hmac:stringToSign :SECRETKEY];
...
+ (NSString *)hmac:(NSString *)plainText:(NSString *)SECRETKEY
{
